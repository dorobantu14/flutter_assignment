...
void main() {
  testWidgets('Main page tap person test', (tester) async {
  ...
  testWidgets('Main page tap on input tab', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: MainScreen(),
      ),
  ...
  testWidgets('Main page logout test', (tester) async {
